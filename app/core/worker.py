...
from app.core.audio import wav_bytes_to_mp3_bytes
from app.core.database import BookRepository, get_connection
        ...
        try:
            ...
            try:
                ...
                if retry_count < MAX_CHAPTER_RETRIES:
                    logger.info(f"Retrying chapter {chapter_id} (Attempt {retry_count + 1}/{MAX_CHAPTER_RETRIES})")
